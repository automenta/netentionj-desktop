...
public class EventEmitter {
    ...
    private ConcurrentMap<Class<?>, ConcurrentMap<Observer, String>> events
            = new ConcurrentHashMap<Class<?>, ConcurrentMap<Observer, String>>();
 
    private BlockingQueue<Runnable> queue = new LinkedBlockingQueue<Runnable>();
    private ExecutorService executorService = new ThreadPoolExecutor(1, 10, 30, TimeUnit.SECONDS, queue);
